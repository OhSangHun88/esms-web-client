...
export default {
    ...
    data() {
      return{
        ...
        selectedEventItems:'', routerCheck:0,
    ...
    getRecipientData() {
        let occurStartDate = moment().subtract(6, 'days').format('YYYY-MM-DD')
        let occurEndDate = moment().format('YYYY-MM-DD')
        if(this.routerCheck === 0){
            occurStartDate = moment().subtract(30, 'minutes').format('YYYY-MM-DD HH:mm:ss')
            occurEndDate = moment().format('YYYY-MM-DD HH:mm:ss')
        }
      let addrCd = ''
      console.log("====================================")
      console.log(occurStartDate)
      console.log(occurEndDate)
      console.log("====================================")
