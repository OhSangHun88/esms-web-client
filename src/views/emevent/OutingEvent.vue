...
export default {
    ...
    getRecipientData() {
      ...
      let uri = ''
      // uri = this.$store.state.serverApi+"/admin/emergencys/out-events?pageIndex="+this.page+"&recordCountPerPage=30"+"&occurStartDate="+occurStartDate+"&occurEndDate="+occurEndDate;;
