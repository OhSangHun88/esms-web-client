...
#gnb ul li{display: inline-block;padding: 0 0 0 60px;}
#gnb ul li a{color: #ADB0BB;font-weight: 500;}
...
#gnb ul li:hover a{color: #11B787;font-weight: 600;}
...
#gnb ul li.on a{color: #11B787;font-weight: 600;}
